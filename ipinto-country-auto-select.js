<script>
  (function() {
    ...
    const IPINFO_TOKEN = '5c9b6753fa75d1';  // Replace with your IPinfo token
    ...
    async function fillCountryDropdown() {
      ...
      if (!countrySelect) {
        console.warn('No country select found');
        return;
      }
    ...
    if (document.readyState === 'loading') {
      document.addEventListener('DOMContentLoaded', fillCountryDropdown);
    } else {
      fillCountryDropdown();
    }
  })();
